...
--box
    GetNormalizedVector(Vector(-0.714, 0.714, kShotgunSpreadDistance)),
    GetNormalizedVector(Vector(0.714, 0.714, kShotgunSpreadDistance)),
    GetNormalizedVector(Vector(0.714, -0.714, kShotgunSpreadDistance)),
    GetNormalizedVector(Vector(-0.714, -0.714, kShotgunSpreadDistance)),
--diamond
...
--pentagon bottom 4
    GetNormalizedVector(Vector(-0.405, -0.295, kShotgunSpreadDistance)),
    GetNormalizedVector(Vector(-0.405, 0.295, kShotgunSpreadDistance)),
    GetNormalizedVector(Vector(0.155, 0.475, kShotgunSpreadDistance)),
    GetNormalizedVector(Vector(0.155, -0.475, kShotgunSpreadDistance)),
--pentagon top
    GetNormalizedVector(Vector(0.5, 0, kShotgunSpreadDistance)),
